...
shutil.copyfile(os.path.join(repo_root, "solutions", "ASSOC-S6", "expected.json"), fixtures)
...
dbutils.fs.put("/Volumes/workspace/de_prep/raw/_grading/ASSOC-S6-report.txt",
               report[-30000:] + f"\n\nexit={exit_code}\n", overwrite=True)
