...
(the study app runs the `generate_datasets_pro_s7` job the first time you open this section; `databricks bundle run generate_datasets_pro_s7 -t free` does the same from a terminal).
