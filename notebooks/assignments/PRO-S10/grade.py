...
# MAGIC %md
# MAGIC # Grade the PRO-S10 assignment
# MAGIC
...
workdir = tempfile.mkdtemp(prefix="grade_pro_s10_")
shutil.copytree(os.path.join(assignment_dir, "tests"), os.path.join(workdir, "tests"))
fixtures = os.path.join(workdir, "expected.json")
shutil.copyfile(os.path.join(repo_root, "solutions", "PRO-S10", "expected.json"), fixtures)
